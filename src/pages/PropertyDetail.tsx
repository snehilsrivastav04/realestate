...
const PropertyDetail = () => {
  ...
  const property = {
    ...
    images: [
      '/images/properties/penthouse-main-1.jpg',
      '/images/properties/penthouse-living-1.jpg',
      '/images/properties/penthouse-bedroom-1.jpg',
      '/images/properties/penthouse-kitchen-1.jpg',
      '/images/properties/penthouse-balcony-1.jpg',
      '/images/properties/penthouse-bathroom-1.jpg',
    ],
    beds: 4,
    baths: 4,
    sqft: 3200,
    ...
    agent: {
      ...
      image: '/images/agents/rajesh-kumar.jpg',
